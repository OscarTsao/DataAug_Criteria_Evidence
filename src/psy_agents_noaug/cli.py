...
from psy_agents_noaug.utils.mlflow_utils import resolve_artifact_location, resolve_tracking_uri
...
def _train_once(
    ...
    if track_mlflow:
        ...
        artifact_location = resolve_artifact_location(
            cfg.mlflow.get("artifact_location"),
            project_root,
        )
...
def hpo(cfg: DictConfig):
    ...
    tracking_uri = resolve_tracking_uri(cfg.mlflow.tracking_uri, project_root)
    artifact_location = resolve_artifact_location(cfg.mlflow.get("artifact_location"), project_root)
